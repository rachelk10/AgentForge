...
@router.put("/{tool_id}/agents/{agent_id}", status_code=status.HTTP_204_NO_CONTENT)
...
@router.delete("/{tool_id}/agents/{agent_id}", status_code=status.HTTP_204_NO_CONTENT)
...
@router.delete("/{tool_id}/agents/{agent_id}/remove", status_code=status.HTTP_204_NO_CONTENT)
...
@router.post("/{tool_id}/agents/{agent_id}/execute", response_model=ToolResult)
